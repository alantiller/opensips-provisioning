...
class Delete
{
    public static function delete($id)
    {
        ...
        try {
            ...
            // Check the current user isnt the one being deleted
            ...
            $local->delete('osp_users', ['id' => $id]);

            // Return response
            http_response_code(200);
            header('Content-Type: application/json');
            echo json_encode(array("data" => array('code' => 200, 'message' => 'User deleted.')));
        } 
    ...
    private static function authenticate()
    {
        ...
        $permission = \Auth\Permissions::canDelete('osp_users', $user['id']);
        if (!$permission)
        {
